...
/* =========================================================================
   ที่อยู่บนบัส I2C
   =========================================================================
   บอร์ด Massmore BME280 (SKU-1023) ดึงขา SDO ขึ้น VDDIO ไว้จากโรงงาน จึงได้
   0x77 เป็นค่าปริยาย ถ้าต่อขา SDO ลง GND (หรือบัดกรีจัมเปอร์ ADDR) จะย้ายไป 0x76
   ทำให้ต่อเซ็นเซอร์สองตัวบนบัสเดียวกันได้

   ดาต้าชีตหัวข้อ 6.2 : SDO = GND -> 0x76, SDO = VDDIO -> 0x77
   ห้ามปล่อย SDO ลอย เพราะ address จะไม่นิ่ง */

#define MASSMORE_BME280_I2C_ADDR_A 0x76 /*!< SDO ลง GND */
#define MASSMORE_BME280_I2C_ADDR_B 0x77 /*!< SDO ขึ้น VDDIO (ค่าปริยายของบอร์ด SKU-1023) */
#define MASSMORE_BME280_I2C_ADDR_DEFAULT MASSMORE_BME280_I2C_ADDR_B /*!< ค่าปริยายที่ begin() ใช้ */

/* =========================================================================
   บัส SPI (4 สาย)
   =========================================================================
   ดาต้าชีตหัวข้อ 6.3 : รองรับ SPI mode 0 และ 3, ความถี่สูงสุด 10 MHz
   ไบต์ควบคุม : บิต 7 = 1 อ่าน / 0 เขียน, บิต 6:0 = ที่อยู่รีจิสเตอร์
   อ่านต่อเนื่องหลายไบต์ได้ (address auto-increment) เหมือน I2C
   บอร์ด Massmore ใช้ 4 สาย (SCK, SDI=MOSI, SDO=MISO, CS) บิต spi3w_en ใน config ต้องเป็น 0 */

#define MASSMORE_BME280_SPI_READ_BIT 0x80  /*!< OR กับ address เมื่ออ่าน */
#define MASSMORE_BME280_SPI_WRITE_MASK 0x7F /*!< AND กับ address เมื่อเขียน */
#define MASSMORE_BME280_SPI_MAX_HZ 10000000UL /*!< ความถี่สูงสุดตามดาต้าชีต */
#define MASSMORE_BME280_SPI_DEFAULT_HZ 1000000UL /*!< ค่าปริยายที่ปลอดภัยกับสายยาว */
